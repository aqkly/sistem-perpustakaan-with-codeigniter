...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" name="nama_bahasa" class="form-control" placeholder="Nama" value="<?=set_value('nama_bahasa') ?>" required>
	</div>
	<div class="form-group">
		<label>Kode Bahasa Buku</label>
		<input type="text" name="kode_bahasa" class="form-control" placeholder="Kode Bahasa" value="<?=set_value('kode_bahasa') ?>" required>
	</div>
	<div class="form-group">
		<label>Urutan</label>
